...
#### generate GPCR expression data frame from different datasets based on raw count gene expression matrix
...
#GPCR list
drg_GPCR=c()
for(i in c(GPCR_list$hgnc_symbol))
  if (i %in% row.names(drg))
    drg_GPCR=c(drg_GPCR,i)

drg_cluster <- drg[drg_GPCR,]
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_somaseq_rawcounts.csv")
```


#### Select effective GCPR expression 
```{r}

## To remove low expression GPCR either with low count or low percentage in all cells and keep effective detection GPCR, introduce two parameters
...
drg_cluster <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_somaseq_rawcounts.csv")


## Select effective detected GPCR
...
effective_detection_GPCR_number=count(detection_index >= Percentage)
single_soma <- drg_cluster[detection_index >= Percentage, "X"]

## print the total number of effective detected GCPRs and save as csv file
print(paste("effective_GPCR_number:", effective_detection_GPCR_number[2,2]))
print(single_soma)
write.csv(single_soma,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_soma_GPCR.csv")
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_nucleuseq_rawcounts.csv")
```
...
## read raw count gene expression matrix
drg_cluster <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_nucleuseq_rawcounts.csv")
...
write.csv(single_nucleus,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_nucleus_GPCR.csv")
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_spatialseq_rawcounts.csv")
```
...
## read raw count gene expression matrix
drg_cluster <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/GPCR_spatialseq_rawcounts.csv")
...
print(paste("effective_GPCR_number:", effective_detection_GPCR_number[2,2]))
print(spatial)
write.csv(spatial,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/spatial_GPCR.csv")

```


### identify the GPCR epxression difference in different dataset 

```{r}

## read data
single_soma_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_soma_GPCR.csv")
single_nucleus_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_nucleus_GPCR.csv")
spatial_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/spatial_GPCR.csv")
...
#### Heatmap to show the GPCR expression difference in different datasets
```{r}
## All GPCRs detected in each three datasets
## read data
single_soma_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_soma_GPCR.csv")
single_nucleus_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/single_nucleus_GPCR.csv")
spatial_list <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/spatial_GPCR.csv")
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_somaseq_rawcounts_common.csv")

single_soma <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_somaseq_rawcounts_common.csv")

selected_rows <- single_soma[single_soma$X %in% merged_unique_elements, ]

write.csv(selected_rows,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_somaseq_rawcounts_heatmap.csv")
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_nucleuseq_rawcounts_common.csv")

single_nucleus <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_nucleuseq_rawcounts_common.csv")

selected_rows <- single_nucleus[single_nucleus$X %in% merged_unique_elements, ]

write.csv(selected_rows,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_nucleuseq_rawcounts_heatmap.csv")
```
...
write.csv(drg_cluster,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_sptial_rawcounts_common.csv")

sptial <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_sptial_rawcounts_common.csv")

selected_rows <- sptial[sptial$X %in% merged_unique_elements, ]

write.csv(selected_rows,"C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_sptial_rawcounts_heatmap.csv")
...
single_soma <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_somaseq_rawcounts_heatmap.csv")
single_nucleus <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_nucleuseq_rawcounts_heatmap.csv")
spatial <- read.csv("C:/E/Posdoc work at Upenn/Lab_work/Projected_I_am_intersted_in/Transcriptome of human DRG neurons/Final analysis for publication/Drug target heat map/database comparison/Heatmap/GPCR_sptial_rawcounts_heatmap.csv")
